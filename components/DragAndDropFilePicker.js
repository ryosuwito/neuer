...
export class DragAndDropFilePicker extends Module {
    ...
    async connectedCallback() {
        ...
        this.allowedTypes = (this.getAttribute('data-allowed-types') || '*').split(',');
        this.maxSize = parseInt(this.getAttribute('data-max-size'), 10) || Infinity;
        ...
        try {
            ...
            this.updateFileInputAccept();  // Update the file input accept attribute
        } catch (error) {
    ...
    initializeModule() {
         ...
         */
        this.triggerFileInput = (event, element) => {
         ...
         */
        this.handleDragOver = (event, element) => {
         ...
         */
        this.handleDragLeave = (event, element) => {
         ...
         */
        this.processFilesInput = (event, element) => {
         ...
         */
        this.processFiles = (event, element, files) => {
         ...
         */
        this.renderImageOrFileNames = (context, element) => {
         ...
         */
        this.openOverlay = (event, element) => {
         ...
         */
        this.stopEventPropagation = (event, element) => {
         ...
         */
        this.closeOverlay = (event, element) => {
            const overlay = this.shadowRoot.querySelector('#imageOverlay');
